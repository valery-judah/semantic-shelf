...
- [x] Full determinism regression tests from section 5.2 are still pending.
- [x] Expanded debug bundle tests from section 5.1 are still pending (sample cap/no-overwrite/pointer-completeness assertions).
